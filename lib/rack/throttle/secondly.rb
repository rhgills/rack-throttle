module Rack; module Throttle
  ...
  # maximum number of allowed HTTP requests per second (by default, 1 request
  # per second).
  ...
  # counter is reset every second on the second (according to the server's local
  # timezone).
  #
  # @example Allowing up to 1 requests per second
  #   use Rack::Throttle::Secondly
  #
  # @example Allowing up to 4 requests per second
  #   use Rack::Throttle::Secondly, :max => 4
  #
